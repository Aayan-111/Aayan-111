...
function resetmode()
	rainbowmode = false
	chaosmode = false
	RecolorTextAndRename("Mayhem real LOLOLOLOLOL", Color3.new(0, 0, 0), Color3.new(1, 1, 0))
	ModeOfGlitch = 1
	storehumanoidWS = 16
	for i, v in pairs(mw2:GetChildren()) do
		if v:IsA("Part") then
	...
	for i, v in pairs(m3:GetChildren()) do
		if v:IsA("Part") then
			v.BrickColor = BrickColor.new("Really yellow")
			v.Material = "Neon"
		end
	end
	for i, v in pairs(extrawingmod1:GetChildren()) do
...
mouse.KeyDown:connect(function(k)
	if k == "q" and attack == false and ModeOfGlitch ~= 2 then
		...
		rainbowmode = false
		chaosmode = false
		RecolorTextAndRename("Puroti", Color3.new(1, 1, 0), Color3.new(1, 0, 1))
		newTheme("rbxassetid://1119453744", 20.25, 1, 1)
		MAINRUINCOLOR = BrickColor.new("Really green")
		for i, v in pairs(mw2:GetChildren()) do
			if v:IsA("Part") then
	...
	if k == "e" and attack == false and ModeOfGlitch ~= 3 then
		...
		rainbowmode = false
		chaosmode = false
		RecolorTextAndRename("Glitchy", Color3.new(0, 0, 0), Color3.new(1, 1, 1))
	...
	if k == "r" and attack == false and ModeOfGlitch ~= 4 then
		...
		rainbowmode = false
		chaosmode = true
		RecolorTextAndRename("??!?!???!??!???!???!??!??!?!?!??!?!???!??!??!?!?!?!??!?!??!??", Color3.new(0, 0, 0), BrickColor.random().Color)
		newTheme("rbxassetid://415898123", 0, 1, 10)
	...
	if k == "t" and attack == false and ModeOfGlitch ~= 5 then
		...
		rainbowmode = false
		chaosmode = false
		RecolorTextAndRename("haha funny nebula star glitcher mode 😂😂", Color3.new(0, 0, 0), Color3.new(255, 255, 255))
   ...
   ModeOfGlitch = 1		
	...
	if k == "y" and attack == false and ModeOfGlitch ~= 6 then
		...
		rainbowmode = false
		chaosmode = false
		RecolorTextAndRename("·", Color3.new(0, 0, 0), Color3.new(1, 1, 1))
	...
	if k == "u" and attack == false and ModeOfGlitch ~= 6127843 then
		...
		rainbowmode = true
		chaosmode = false
		RecolorTextAndRename("calamity but ???!??", Color3.new(1.35453, 1, 4), Color3.new(4, 2, 1))
